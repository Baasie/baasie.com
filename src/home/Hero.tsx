        ...
        <div tw="p-8 bg-gray-800 shadow-lg bg-opacity-80">
            <div tw="flex flex-row items-center justify-around m-8">
                <div tw="text-center text-white w-2/5 space-y-6 text-shadow">
                    <h1 tw="">Hi, I am Kenny Baas-Schwegler</h1>
                    <div>
                    ...
                    I am a sociotechnical architect working with CTO's, managers, architect and teams to change that to design and build sustainable quality software that can change with business needs!
                    </div>
                    <div>
